...
impl ClientManager {
    ...
    pub fn send_json(&self, json_content: &str, verbosity: &VerbosityConfig) -> Result<()> {
        verbosity.print_verbose("Sending JSON directly to server...");
